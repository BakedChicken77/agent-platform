...
from schema.models import AllModelEnum, AzureOpenAIModelName, OpenAIModelName
...
class UserInput(BaseModel):
    ...
    model: SerializeAsAny[AllModelEnum] | None = Field(
        ...
        examples=[OpenAIModelName.GPT_4O_MINI, AzureOpenAIModelName.AZURE_GPT_4O_MINI],
    )
